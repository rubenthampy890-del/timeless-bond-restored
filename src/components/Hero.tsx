    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-light text-primary-foreground leading-tight mb-8 animate-fade-up animation-delay-200">
            Where Love Becomes
            <span className="block italic mt-2">a Timeless Bond</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 animate-fade-up animation-delay-600">
            <a
              href="#contact"
              className="group relative px-10 py-4 bg-primary text-primary-foreground font-body text-sm tracking-luxury uppercase transition-all duration-500 hover:bg-primary/90"
            >
              <span className="relative z-10">Begin Your Journey</span>
            </a>
            <a
              href="#contact"
              className="px-10 py-4 border border-primary-foreground/40 text-primary-foreground font-body text-sm tracking-luxury uppercase transition-all duration-500 hover:bg-primary-foreground/10 hover:border-primary-foreground"
            >
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 scroll-indicator">
        <div className="flex flex-col items-center text-primary-foreground/60">
          <span className="font-body text-xs tracking-luxury uppercase mb-3">Scroll</span>
